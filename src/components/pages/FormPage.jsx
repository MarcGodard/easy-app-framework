  ...
  <Page>
    ...
    <List form>
      ...
      <ListItem>
        <Label>Slider</Label>
        <Input>
          <Range min='0' max='100' value={slider} step='1' label onRangeChanged={(value) => onSliderUpdated(value)} />
        </Input>
      </ListItem>
      <ListItem>
        <Label>Textarea</Label>
        <Input type='textarea' placeholder='Bio' onChange={({ target }) => onTextAreaUpdated(target.value)} value={textArea} />
      </ListItem>
      <ListItem>
        <Label>Resizable</Label>
        <Input type='textarea' placeholder='Bio' resizable onChange={({ target }) => onResizableUpdated(target.value)} value={resizable} />
      </ListItem>
    </List>
